        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-surface-dark rounded-[2rem] border border-slate-100 dark:border-surface-border p-6 space-y-6 shadow-sm">
            <div>
              ...
              <p className="text-sm font-black text-slate-900 dark:text-white">{user?.name || 'Khách hàng'}</p>
              <p className="text-xs text-slate-500 mt-1">{user?.phone || 'Chưa cập nhật SĐT'}</p>
