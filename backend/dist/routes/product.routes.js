...
router.delete('/:id', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, async (req, res) => {
    const { id } = req.params;
    try {
        await prisma_1.prisma.product.delete({ where: { id: Number(id) } });
...
router.post('/bulk-delete', auth_middleware_1.authenticate, auth_middleware_1.requireAdmin, async (req, res) => {
...
router.post('/:id/reviews', auth_middleware_1.authenticate, async (req, res) => {
    const { id } = req.params;
